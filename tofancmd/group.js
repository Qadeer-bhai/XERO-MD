...
//const { getGroupe } = require("../tofandatabase/groupe")
const { Sticker, StickerTypes } = require('wa-sticker-formatter');
const {ajouterOuMettreAJourJid,mettreAJourAction,verifierEtatJid} = require("../tofandatabase/antilien")
const {atbajouterOuMettreAJourJid,atbverifierEtatJid} = require("../tofandatabase/antibot")
...
const cron = require(`../tofandatabase/cron`) ;
...
ezra({
  ...
  if(!verifAdmin) { repondre('Sorry, you cannot enable NSFW content without being an administrator of the group') ; return}
      ...
      let hbd = require('../tofandatabase/hentai') ;
