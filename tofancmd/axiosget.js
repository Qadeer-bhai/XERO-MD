    ...
    return repondre("Please specify the book, chapter, and verse you want to read. Example: bible Mathew 3:16", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://qu.ax/NfJZk.jpg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
...
ezra({
  ...
  if (!arg || arg.length === 0) {
    const replyText = "Example Usage: .code 923xxxxxx.";
    return repondre(replyText);
  }

  try {
    // Notify user that pairing is in progress
    const replyText = "*Wait XERO Md is getting your pair code 🍼✅...*";
...
Regards ${conf.BOT} `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "XERO-MD ELEMENT INFORMATION",
...
`;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "XERO-MD GITHUB USER INFO",
